...
export default function InviteRedirectPage() {
  ...
  if (!showFallback) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-gradient-to-b from-[#1a1a2e] to-[#16213e] p-4">
        <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-white/20 border-t-white" />
        <p className="text-sm text-gray-300">Abrindo o aplicativo...</p>
      </div>
    );
  }

  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8 bg-gradient-to-b from-[#1a1a2e] to-[#16213e] p-4 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold text-white">
          Voc&ecirc; foi convidado para o <span className="text-blue-400">Zelo</span>
        </h1>
      ...
      <div className="space-y-3 rounded-lg border border-white/10 bg-white/5 p-6">
        ...
        <div className="flex justify-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-md bg-white px-4 py-2 text-sm font-medium text-[#1a1a2e] hover:bg-gray-100"
          >
